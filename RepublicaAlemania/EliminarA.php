...
<script type="text/javascript">
	function eliminarCliente() {
		var pregunta=confirm("Deseas eliminar el alumno");
		if(pregunta==true){
			return true;
		}else{
			return false;
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <?php
          ...
          $arreglo = array('codigoAlumno' => $datoA);
          $datos = $alumno->find($arreglo);
          ...
          foreach($datos as $dato){ ?>
                ...
                <tr>
					<th style="padding-right: 35%;"><center><button onclick="return eliminarCliente()" name="eliminarAlumn" class="btn btn-danger" id="almacenamiento" value="Eliminar">Eliminar</button></center><input type="hidden" class="form-control" name="codigo" value="<?php echo $dato['_id']; ?>" ></th>	
					<th></th>
				</tr>
				</form>
            <?php
