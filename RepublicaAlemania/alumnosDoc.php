...
<div class="row" style="padding-left: 5%;">
  <div class="col-md-12" style="position: absolute;">
      <h3 style="padding-top: 3%;">Estudiantes</h3>
  </div>

  <div class="col-md-12" style="width: 1100px; position: absolute; top: 100px;">
    <table class="table">
      <thead>
        ...
        <?php 
         ...
         foreach($datos as $dato){ ?>
            <tr style="font-size: 15px;">
                  ...
                  <td><a href="editarAlum.php?idA=<?php echo $dato["_id"];?>"><button type='button' class="btn btn-primary" style="font-size: 14px;">Editar</button></a></td>
                </tr>
            <?php
          }
        ?>
