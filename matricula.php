...
<div class="row">
  ...
  <div class="col-md-6" style="padding-left: 15%;">
    ...
    <form class="row g-2" method="post" action="addMatricula.php" style="width: 900px;">
        ...
        <div class="col-md-7">
          <label for="inputEmail4" class="form-label">Nombres *</label>
          <input type="text" class="form-control" name="nombresR" placeholder="Escribe tus nombres">
        </div>
        <div class="col-md-5"></div>
        <div class="col-md-7">
          <label for="inputPassword4" class="form-label">Apellidos *</label>
          <input type="text" class="form-control" name="apellidosR" placeholder="Escribe tus apellidos">
        </div>
        <div class="col-md-5"></div>
        <div class="col-7">
        ...
        <div class="col-md-4">
          <label for="inputState" class="form-label">Sexo *</label>
          <select id="seccion" name="sexoR" class="form-select">
            <option selected>Elegir...</option>
            <option>Femenino</option>
            <option>Masculino</option>
          </select>
        ...
        <div class="col-md-12">
         ...
         <div class="col-md-7">
          ...
          <input type="text" class="form-control" name="deparR" placeholder="Ejemplo: Ahuachapán">
        </div>
         <div class="col-md-7">
          <label for="inputEmail4" class="form-label">Municipio *</label>
          <input type="text" class="form-control" name="municipioR" placeholder="Ejemplo: Turín">
        </div>
         <div class="col-md-7">
          <label for="inputEmail4" class="form-label">Caserio, Colonia o Cantón *</label>
          <input type="text" class="form-control" name="caserioR" placeholder="Ejemplo: Las pozas">
        </div>
         <div class="col-md-7">
          <label for="inputEmail4" class="form-label">Dirección completa *</label>
          <input type="text" class="form-control" name="direccionR" placeholder="Ejemplo: Colonia las pozas, Turin, Ahuachapán">
        </div>
       <br>
